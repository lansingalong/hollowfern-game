...
const INTERACTIONS = {
    PORCH: [
        { id: 1, x: 53, y: 21, text: "Herb bundles tied with twine hanging to dry under the eaves. They look like they've been here for a while." },
